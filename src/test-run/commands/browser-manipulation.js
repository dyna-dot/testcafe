...
// Commands
class BaseScreenshotCommand extends Assignable {
    constructor (obj) {
        super(obj);
...
export class TakeScreenshotCommand extends BaseScreenshotCommand {
    constructor (obj) {
        super(obj);
...
export class TakeScreenshotOnFailCommand extends BaseScreenshotCommand {
    constructor () {
        super();
