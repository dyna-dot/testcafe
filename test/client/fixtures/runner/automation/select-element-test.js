...
$(document).ready(function () {
    ...
    // NOTE: Android and iOS ignores size and multiple attributes, all select elements behave like select with size=1
    if (isMobileBrowser) {

        asyncTest('click on option  raises error in select with size more than one when option list is collapsed', function () {
            SETTINGS.ENABLE_SOURCE_INDEX = true;
        ...
        asyncTest('click on option  raises error in select with multiple attribute when option list is collapsed', function () {
            SETTINGS.ENABLE_SOURCE_INDEX = true;
            var select                   = createSelect();
            var option                   = $(select).children()[1];
    ...
    // NOTE: Android and iOS ignore size and multiple attributes, all select elements behave like select with size=1
    if (isMobileBrowser) {

        module('mouse actions with multiline select element');
        asyncTest('click on select element with size attribute greater than one and on option', function () {
            var select = createSelect(2),
                option = $(select).children()[2];
        ...
        asyncTest('click on select element with multiple attribute and on option', function () {
            var select = createSelect(),
                option = $(select).children()[2];
   ...
   // NOTE: Android ignores size and multiple attributes, all select elements behave like select with size=1
   if (!isMobileBrowser) {
